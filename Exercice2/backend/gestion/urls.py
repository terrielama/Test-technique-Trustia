...
from .views import liste_produits, creer_produit, modifier_produit, supprimer_produit, creer_facture, detail_facture, liste_factures, all_produits

urlpatterns = [
# ----- Gestion des produits -----
    path('produits/', liste_produits, name='liste_produits'),
    path('produits/all/', all_produits, name='all_produits'),
