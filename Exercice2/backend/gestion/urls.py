...
from .views import liste_produits, creer_produit, modifier_produit, supprimer_produit, creer_facture, detail_facture
...
# ----- Facturation -----
    path("factures/creer/", creer_facture),
    path("factures/<int:id>/", detail_facture),
]